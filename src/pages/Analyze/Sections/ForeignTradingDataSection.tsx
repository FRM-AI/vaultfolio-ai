...
import { Loader2, RefreshCw, Building2, ChevronDown, ChevronUp, Info } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
            ...
            {onAnalyze && (
              ...
              >
                ...
                <ProBadge serviceType="foreign_trading_analysis" showTooltip={false} />
              </Button>
            )}
          </div>
        </CardTitle>
            ...
            <CollapsibleContent>
              ...
              <Alert className="mb-4 border-primary/30 bg-primary/5">
                ...
                <AlertDescription className="text-sm">
                  <span className="font-semibold">💡 Mẹo:</span> Di chuột qua từng ngày để xem chi tiết giao dịch mua/bán
                </AlertDescription>
              </Alert>
